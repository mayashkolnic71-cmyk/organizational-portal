...
const quizzesData = {
    'infections': {
        ...
        fields: [
            ...
            { id: 'entry.q1', type: 'radio', label: { he: 'מבדק ידע: שאלה 1: איזו פעולה מפחיתה את הסיכון לזיהומים במוסד הגריאטרי?', en: 'Knowledge test: Question 1: Which action reduces the risk of infections in a geriatric institution?', ar: 'اختبار المعرفة: السؤال 1: أي إجراء يقلل من خطر العدوى في مؤسسة رعاية المسنين؟', ru: 'Тест на знания: Вопрос 1: Какое действие снижает риск заражения в гериатрическом учреждении?' }, options: [
                ...
                { val: 'הגיינת ידיים לפני ואחרי כל טיפול בחולה', label: { he: 'הגיינת ידיים לפני ואחרי כל טיפול בחולה', en: 'Hand hygiene before and after any patient care', ar: 'نظافة اليدين قبل وبعد أي رعاية للمريض', ru: 'Гигиена рук до и после ухода за пациентом' } },
                { val: 'חיטוי חדרים בלבד', label: { he: 'חיטוי חדרים בלבד', en: 'Room disinfection only', ar: 'تطهير الغرف فقط', ru: 'Только дезинфекция помещений' } },
            ...
            { id: 'entry.q2', type: 'radio', label: { he: 'שאלה 2: מתי יש לשטוף ידיים במים וסבון?', en: 'Question 2: When should hands be washed with soap and water?', ar: 'السؤال 2: متى يجب غسل اليدين بالماء والصابون؟', ru: 'Вопрос 2: Когда следует мыть руки с мылом и водой?' }, options: [
                { val: 'בכל מצב יש לשטוף ידיים', label: { he: 'בכל מצב יש לשטוף ידיים', en: 'Hands should be washed in any situation', ar: 'يجب غسل اليدين في أي حالة', ru: 'Руки следует мыть в любой ситуации' } },
                { val: 'כשיש לכלוך נראה לעין חובה לשטוף במים וסבון', label: { he: 'כשיש לכלוך נראה לעין חובה לשטוף במים וסבון', en: 'When there is visible dirt, it is mandatory to wash with soap and water', ar: 'عند وجود أوساخ مرئية، يجب غسل اليدين بالماء والصابون', ru: 'При видимых загрязнениях обязательно мыть руки с мылом и водой' } },
                { val: 'חיטוי בתכשיר אלכוהולי במקום שטיפת ידיים', label: { he: 'חיטוי בתכשיר אלכוהולי במקום שטיפת ידיים', en: 'Alcohol-based hand rub instead of hand washing', ar: 'استخدام معقم كحولي بدلاً من غسل اليدين', ru: 'Обработка спиртосодержащим средством вместо мытья рук' } },
                { val: 'אף אחת מהתשובות לא נכונה', label: { he: 'אף אחת מהתשובות לא נכונה', en: 'None of the answers are correct', ar: 'لا توجد إجابة صحيحة', ru: 'Ни один из ответов не верен' } }
            ] },
            { id: 'entry.q3', type: 'radio', label: { he: 'שאלה 3: מה המשפט הנכון לאחר הסרת כפפות?', en: 'Question 3: What is the correct statement after removing gloves?', ar: 'السؤال 3: ما هي العبارة الصحيحة بعد خلع القفازات؟', ru: 'Вопрос 3: Какое утверждение верно после снятия перчаток?' }, options: [
                { val: 'יש לשטוף ידיים במים וסבון', label: { he: 'יש לשטוף ידיים במים וסבון', en: 'Hands should be washed with soap and water', ar: 'يجب غسل اليدين بالماء والصابون', ru: 'Руки следует вымыть с мылом и водой' } },
                { val: 'יש לחטא בתכשיר אלכוהולי', label: { he: 'יש לחטא בתכשיר אלכוהולי', en: 'Hands should be disinfected with alcohol-based rub', ar: 'يجب تعقيم اليدين بمعقم كحولي', ru: 'Руки следует обработать спиртосодержащим средством' } },
                { val: 'אין צורך בשטיפה או חיטוי כי השתמשתי בכפפות', label: { he: 'אין צורך בשטיפה או חיטוי כי השתמשתי בכפפות', en: 'No need to wash or disinfect because I used gloves', ar: 'لا حاجة للغسيل أو التعقيم لأنني استخدمت القفازات', ru: 'Нет необходимости мыть или дезинфицировать, так как я использовал перчатки' } },
                { val: 'תשובה 1 ו 2 נכונות', label: { he: 'תשובה 1 ו 2 נכונות', en: 'Answers 1 and 2 are correct', ar: 'الإجابات 1 و 2 صحيحة', ru: 'Ответы 1 и 2 верны' } }
            ] },
            { id: 'entry.q4', type: 'radio', label: { he: 'שאלה 4: מהו משך זמן נכון לשטוף ידיים במים וסבון?', en: 'Question 4: What is the correct duration to wash hands with soap and water?', ar: 'السؤال 4: ما هي المدة الصحيحة لغسل اليدين بالماء والصابون؟', ru: 'Вопрос 4: Какова правильная продолжительность мытья рук с мылом и водой?' }, options: [
                { val: '15 שניות', label: { he: '15 שניות', en: '15 seconds', ar: '15 ثانية', ru: '15 секунд' } },
                { val: '5-10 שניות', label: { he: '5-10 שניות', en: '5-10 seconds', ar: '5-10 ثواني', ru: '5-10 секунд' } },
                { val: 'דקה', label: { he: 'דקה', en: 'A minute', ar: 'دقيقة', ru: 'Минута' } },
                { val: '20-40 שניות', label: { he: '20-40 שניות', en: '20-40 seconds', ar: '20-40 ثانية', ru: '20-40 секунд' } }
            ] },
            { id: 'entry.q5', type: 'radio', label: { he: 'שאלה 5: מה ריכוז הכלור הנדרש לניקיון יום יומי של חדר מטופל?', en: 'Question 5: What is the required chlorine concentration for daily cleaning of a patient room?', ar: 'السؤال 5: ما هو تركيز الكلور المطلوب للتنظيف اليومي لغرفة المريض؟', ru: 'Вопрос 5: Какова требуемая концентрация хлора для ежедневной уборки палаты пациента?' }, options: [
                { val: '1000ppm לליטר מים', label: { he: '1000ppm לליטר מים', en: '1000ppm per liter of water', ar: '1000 جزء في المليون لكل لتر من الماء', ru: '1000 ppm на литр воды' } },
                { val: '2000ppm לליטר מים', label: { he: '2000ppm לליטר מים', en: '2000ppm per liter of water', ar: '2000 جزء في المليون لكل لتر من الماء', ru: '2000 ppm на литр воды' } },
                { val: '5000ppm לליטר מים', label: { he: '5000ppm לליטר מים', en: '5000ppm per liter of water', ar: '5000 جزء في المليون لكل لتر من الماء', ru: '5000 ppm на литр воды' } },
                { val: '10000ppm לליטר מים', label: { he: '10000ppm לליטר מים', en: '10000ppm per liter of water', ar: '10000 جزء في المليون لكل لتر من الماء', ru: '10000 ppm на литр воды' } }
            ] },
            { id: 'entry.q6', type: 'radio', label: { he: 'שאלה 6: מה החשיבות של ניקיון וחיטוי סביבתי במוסד רפואי?', en: 'Question 6: What is the importance of environmental cleaning and disinfection in a medical facility?', ar: 'السؤال 6: ما هي أهمية التنظيف والتطهير البيئي في منشأة طبية؟', ru: 'Вопрос 6: Какова важность экологической уборки и дезинфекции в медицинском учреждении?' }, options: [
                { val: 'שמירה על מראה אסתטי', label: { he: 'שמירה על מראה אסתטי', en: 'Maintaining an aesthetic appearance', ar: 'الحفاظ على مظهر جمالي', ru: 'Поддержание эстетичного вида' } },
                { val: 'מניעת העברת זיהומים ושבירת רצף ההדבקה בין מטופלים צוות ומבקרים', label: { he: 'מניעת העברת זיהומים ושבירת רצף ההדבקה בין מטופלים צוות ומבקרים', en: 'Preventing transmission of infections and breaking the chain of infection', ar: 'منع انتقال العدوى وكسر سلسلة العدوى', ru: 'Предотвращение передачи инфекций и разрыв цепи заражения' } },
                { val: 'חיסכון בזמן עבודת הצוות', label: { he: 'חיסכון בזמן עבודת הצוות', en: 'Saving staff work time', ar: 'توفير وقت عمل الموظفين', ru: 'Экономия рабочего времени персонала' } },
                { val: 'הפחתת הצורך בטיפול תרופתי בלבד', label: { he: 'הפחתת הצורך בטיפול תרופתי בלבד', en: 'Reducing the need for medical treatment only', ar: 'تقليل الحاجة إلى العلاج الطبي فقط', ru: 'Снижение потребности в медикаментозном лечении' } }
            ] },
            { id: 'entry.q7', type: 'radio', label: { he: 'שאלה 7: מהו השיקול המרכזי בקביעת סוג הבידוד למטופל על פי נוהל מחוללים רבי-עמידויות?', en: 'Question 7: What is the main consideration in determining the type of isolation for a patient?', ar: 'السؤال 7: ما هو الاعتبار الرئيسي في تحديد نوع العزل للمريض؟', ru: 'Вопрос 7: Что является главным соображением при определении типа изоляции для пациента?' }, options: [
                { val: 'גיל המטופל ומצבו התפקודי', label: { he: 'גיל המטופל ומצבו התפקודי', en: 'Patient\'s age and functional status', ar: 'عمر المريض وحالته الوظيفية', ru: 'Возраст пациента и функциональное состояние' } },
                { val: 'דרכי העברת המחולל הזיהומי', label: { he: 'דרכי העברת המחולל הזיהומי', en: 'Mode of transmission of the infectious agent', ar: 'طريقة انتقال العامل المعدي', ru: 'Путь передачи возбудителя инфекции' } },
                { val: 'משך האשפוז הצפוי', label: { he: 'משך האשפוז הצפוי', en: 'Expected length of hospitalization', ar: 'مدة الإقامة المتوقعة في المستشفى', ru: 'Ожидаемая продолжительность госпитализации' } },
                { val: 'זמינות חדרי הבידוד במחלקה', label: { he: 'זמינות חדרי הבידוד במחלקה', en: 'Availability of isolation rooms in the department', ar: 'توفر غرف العزل في القسم', ru: 'Наличие изоляторов в отделении' } }
            ] },
            { id: 'entry.q8', type: 'radio', label: { he: 'שאלה 8: מי מוסמך להחליט על הפעלת בידוד למטופל?', en: 'Question 8: Who is authorized to decide on initiating patient isolation?', ar: 'السؤال 8: من المخول بتقرير بدء عزل المريض؟', ru: 'Вопрос 8: Кто уполномочен принимать решение о начале изоляции пациента?' }, options: [
                { val: 'אחות אחראית בלבד', label: { he: 'אחות אחראית בלבד', en: 'Nurse in charge only', ar: 'الممرضة المسؤولة فقط', ru: 'Только старшая медсестра' } },
                { val: 'רופא בלבד', label: { he: 'רופא בלבד', en: 'Doctor only', ar: 'الطبيب فقط', ru: 'Только врач' } },
                { val: 'רופא, אחות, נאמן מחלקתי או ועדת זיהומים', label: { he: 'רופא, אחות, נאמן מחלקתי או ועדת זיהומים', en: 'Doctor, nurse, department champion, or infection committee', ar: 'طبيب، ممرضة، مسؤول القسم، أو لجنة العدوى', ru: 'Врач, медсестра, ответственный в отделении или комитет по инфекциям' } },
            ...
            { id: 'entry.q9', type: 'radio', label: { he: 'שאלה 9: מה נדרש לגבי ציוד רפואי בחדר בידוד?', en: 'Question 9: What is required regarding medical equipment in an isolation room?', ar: 'السؤال 9: ما هو المطلوب بشأن المعدات الطبية في غرفة العزل؟', ru: 'Вопрос 9: Каковы требования к медицинскому оборудованию в изоляторе?' }, options: [
                { val: 'שימוש בציוד משותף לאחר חיטוי בלבד', label: { he: 'שימוש בציוד משותף לאחר חיטוי בלבד', en: 'Using shared equipment after disinfection only', ar: 'استخدام المعدات المشتركة بعد التطهير فقط', ru: 'Использование общего оборудования только после дезинфекции' } },
                { val: 'הקצאת ציוד אישי או חד-פעמי למטופל', label: { he: 'הקצאת ציוד אישי או חד-פעמי למטופל', en: 'Allocating personal or single-use equipment to the patient', ar: 'تخصيص معدات شخصية أو ذات استخدام واحد للمريض', ru: 'Выделение пациенту личного или одноразового оборудования' } },
                { val: 'הוצאת ציוד מהחדר ללא ניקוי', label: { he: 'הוצאת ציוד מהחדר ללא ניקוי', en: 'Removing equipment from the room without cleaning', ar: 'إخراج المعدات من الغرفة بدون تنظيف', ru: 'Вынос оборудования из палаты без очистки' } },
                { val: 'שימוש בציוד רב-פעמי בלבד', label: { he: 'שימוש בציוד רב-פעמי בלבד', en: 'Using reusable equipment only', ar: 'استخدام المعدات القابلة لإعادة الاستخدام فقط', ru: 'Использование только многоразового оборудования' } }
            ] },
            { id: 'entry.q10', type: 'radio', label: { he: 'שאלה 10: כיצד יש לנהוג בעובד המסרב להתחסן?', en: 'Question 10: How should an employee who refuses to be vaccinated be handled?', ar: 'السؤال 10: كيف يجب التعامل مع الموظف الذي يرفض التطعيم؟', ru: 'Вопрос 10: Как следует поступать с сотрудником, который отказывается от вакцинации?' }, options: [
                { val: 'לאפשר עבודה ללא תיעוד', label: { he: 'לאפשר עבודה ללא תיעוד', en: 'Allow work without documentation', ar: 'السماح بالعمل دون توثيق', ru: 'Разрешить работу без документации' } },
                { val: 'להשעותו מיד', label: { he: 'להשעותו מיד', en: 'Suspend them immediately', ar: 'إيقافه عن العمل فوراً', ru: 'Немедленно отстранить от работы' } },
                { val: 'להסביר את ההשלכות ולתעד סירוב חתום', label: { he: 'להסביר את ההשלכות ולתעד סירוב חתום', en: 'Explain the consequences and document a signed refusal', ar: 'شرح العواقب وتوثيق رفض موقع', ru: 'Объяснить последствия и задокументировать подписанный отказ' } },
